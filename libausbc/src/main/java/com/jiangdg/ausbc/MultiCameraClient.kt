...
class MultiCameraClient(ctx: Context, callback: IDeviceConnectCallBack?) {
    ...
    open abstract class ICamera(val ctx: Context, val device: UsbDevice): Handler.Callback,
         ...
         */
        public open fun captureAudioStart(callBack: ICaptureCallBack, mp3Path: String?=null) {
         ...
         * Stop rec mp3
         */
        public open fun captureAudioStop() {
         ...
         */
        public open fun startPlayMic(callBack: IPlayCallBack?) {
            if (! CameraUtils.hasAudioPermission(mContext)) {
                callBack?.onError("Has no audio permission")
                return
            }
         ...
         */
        public open fun setRotateType(type: RotateType?) {
         ...
         */
        public open fun setRenderSize(width: Int, height: Int) {
         ...
         */
        public open fun addRenderEffect(effect: AbstractEffect) {
            mRenderManager?.addRenderEffect(effect)
        }
         ...
         */
        public open fun removeRenderEffect(effect: AbstractEffect) {
         ...
         */
        public open fun getDefaultEffect() = mCameraRequest?.defaultEffect
         ...
         */
        public open fun updateRenderEffect(classifyId: Int, effect: AbstractEffect?) {
         ...
         */
        public open fun setUsbControlBlock(ctrlBlock: USBMonitor.UsbControlBlock?) {
         ...
         */
        public open fun getUsbDevice() = device
         ...
         */
        public open fun isMicSupported(device: UsbDevice?) = CameraUtils.isCameraContainsMic(device)
         ...
         */
        public open fun <T> openCamera(cameraView: T? = null, cameraRequest: CameraRequest? = null) {
         ...
         */
        public open fun isCameraOpened() = isPreviewed
         ...
         */
        public open fun captureStreamStart() {
         ...
         * Capture stream stop
         */
        public open fun captureStreamStop() {
         ...
         */
        @RequiresApi(Build.VERSION_CODES.O)
        public open fun updateResolution(width: Int, height: Int) {
         ...
         */
        public open fun setCameraStateCallBack(callback: ICameraStateCallBack?) {
         ...
         */
        public open fun setEncodeDataCallBack(callBack: IEncodeDataCallBack?) {
         ...
         */
        public open fun addPreviewDataCallBack(callBack: IPreviewDataCallBack) {
         ...
         * @param callBack preview data call back
         */
        public open fun removePreviewDataCallBack(callBack: IPreviewDataCallBack) {
            if (! mPreviewDataCbList.contains(callBack)) {
                return
            }
        ...
        public open fun isPreviewSizeSupported(previewSize: PreviewSize): Boolean {
        ...
        @RequiresApi(Build.VERSION_CODES.O)
        public open fun isRecording() = mMediaMuxer?.isMuxerStarter() == true

        public open fun isStreaming() = mVideoProcess?.isEncoding() == true || mAudioProcess?.isEncoding() == true
